...
<header>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="PromoPart">
                    <h2>Know what your Facebook friends &amp; LinkedIn connections convey about your personality</h2>
                    <div class="tcenter">
                    	<div id="facebook">
                    		<a href="#">
                    ...
                    <div class="mobile">
                        ...
                        <div class="picCont">
                        	<g:img dir="images" file="avatar.png" alt="name" style="padding-left:18px; padding-top:10px; width:90px; height:90px;"/>
  ...
  function onLinkedInAuth() {
	  if (fbLogged) {
		  if(!IN.User.isAuthorized()){
	  	  ...
	  	  $.post(getContextPath()+"admin/linkedinLogin"
	  		  ,{fid : fbId
	  		  }
			  ,function (data, status) {
...
<script type="text/javascript">
  ...
  data.addRows([
    ['Socialite', status.facebook_count],
    ['Boundary Spanner', status.overlap],
    ['Professional Guru', status.linkedin_count], 
