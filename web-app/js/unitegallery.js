...
function UGSlider() {
    ...
    var g_objTouchSlider, g_objZoomSlider, g_objZoomPanel, g_objSharePanel, g_objButtonPlay = null, g_objButtonFullscreen = null, g_objBullets = null;
    ...
    var g_options = {
        ...
        slider_enable_share_panel: true, //true,false - enable the share buttons
        slider_sharepanel_skin: "", //skin of the slider share panel, if empty inherit from gallery skin		  
        slider_sharepanel_align_hor: "right", //left, center, right - share panel horizontal align
        slider_sharepanel_align_vert: "top", //top, middle, bottom - share panel vertical align
        slider_sharepanel_offset_hor: 80, //share panel horizontal offset 
        slider_sharepanel_offset_vert: 10, //share panel vertical offset
        slider_sharepanel_mobilehide: false
    };
    ...
    function initSlider(objGallery, objOptions, optionsPrefix) {
        ...
        if (g_options.slider_enable_share_panel) {
            g_objSharePanel = new UGShareButtonsPanel();
            g_objSharePanel.init(g_gallery, g_options);
        }
    ...
    function processOptions() {
        ...
        if (g_options.slider_sharepanel_skin == "")
            g_options.slider_sharepanel_skin = globalSkin;
    ...
    function setHtmlSlider(objParent) {
        ...
        //add zoom buttons panel:
        if (g_options.slider_enable_share_panel= true) {
            g_objSharePanel.appendHTML(g_objSlider);
        }
    ...
    function positionElements() {
        ...
        //place share icons
        if (g_options.slider_enable_share_panel == true) {
            var sharePanelElement = g_objSharePanel.getElement();
            g_functions.placeElement(sharePanelElement, g_options.slider_sharepanel_align_hor, g_options.slider_sharepanel_align_vert, g_options.slider_sharepanel_offset_hor, g_options.slider_sharepanel_offset_vert);
        }
...
/** -------------- UGShareButtonsPanel class ---------------------*/

/**
 * share buttons panel class
 */
function UGShareButtonsPanel() {

    var t = this;
    var g_gallery, g_objPanel, g_objParent, g_objButtonFacebook, objItem;
    var g_functions = new UGFunctions();

    var g_options = {
        slider_sharepanel_skin: ""		//skin of the share panel, if empty inherit from gallery skin
    };
    ...
    this.appendHTML = function (objParent) {
        ...
        var html = "<div class='ug-slider-control ug-sharepanel ug-skin-" + g_options.slider_sharepanel_skin + "'>";

        html += "<div class='ug-sharepanel-button ug-sharepanel-facebook'></div>";

        html += "</div>";

        objParent.append(html);

        g_objPanel = objParent.children(".ug-sharepanel");
        g_objButtonFacebook = g_objPanel.children(".ug-sharepanel-facebook");
     ...
     */
    function onItemChange() {
        objItem = g_gallery.getSelectedItem();
    }


       /**
     * init sharepanel events
     */
    function initEvents () {

        //set buttons click events

        g_functions.setButtonOnClick(g_objButtonFacebook, function () {
            
            window.location.href = "https://www.facebook.com/sharer/sharer.php?u="+objItem.urlImage;
            
//            FB.ui({
//  		  method: 'share',
//  		  href: objItem.urlImage,
//  		}, function(response){
